...
<% 
                rst=stmt.executeQuery("select * from StudentTab order by courseName,RegNo");
		
                while( rst.next())
                {
                out.println("<tr><td height=20>"+rst.getString("RegNo")+ " </td><td height=20>"+rst.getString("StudentName")+ " </td>  <td height=20>"+rst.getString("MobileNo")+ " </td><td> " + rst.getString("CourseName")+ "</td></tr>" );
                }
