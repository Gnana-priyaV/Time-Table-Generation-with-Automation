...
<html>
    <style>
       ...
       body{
                background-image: url('images/time5.jpeg');
...
response.sendRedirect("admincoursedetails.jsp?msg=success");
}
...
<!--<form method="POST"    action="admincoursedetails.jsp">
<table border="0"> 
...
<tr> <td height="40">  </td> <td align="center"> <input type="submit" name="Login" ></td> </tr>       
       ...
       <form method="POST"    action="admincoursedetails.jsp">
            <table border="0"> 
                ...
                <tr> <td height="20" colspan="2">Course DETAILS</td> </tr>    
                <tr> <td height="60" colspan="2"><hr> </td> </tr> 
                <tr> <td height="20"> Course Name</td> <td> 
                        <select name="text1" >
