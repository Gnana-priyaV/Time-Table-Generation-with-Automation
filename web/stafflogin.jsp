...
if(t1!=null&&t1!=""){
rst=stmt.executeQuery("select * from empDetTab where empcode= '" + t1 + "' and pWord='" + t2 + "'");
if (rst.next())
{out.println("Login Successful");
session.setAttribute( "empcodevar", t1 );
response.sendRedirect("staffmainpage.jsp?msg=success");
}
else{
                    
                     response.sendRedirect("stafflogin.jsp?msg=failed");
                               }
...
<!--<div id="id01" class="">
  ...
  <form class="modal-content animate" action="stafflogin.jsp" method="post">
    <div class="imgcontainer">
      <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">&times;</span>
      <img src="images/avatar.png" alt="Avatar" class="avatar" style="width:180px;height: 180px;">
      <h3>STAFF LOGIN</h3>
    </div>
...
.topnav a.active {
  ...
  color: white;
    ...
    <a class="active" href="stafflogin.jsp">STAFF LOGIN</a>
    ...
    <div class="content">
        ...
        <form action="stafflogin.jsp" method="post">
            <div class="field">
                ...
                <input type="text" required="" placeholder="Staff Id" name="text1">
            </div>
